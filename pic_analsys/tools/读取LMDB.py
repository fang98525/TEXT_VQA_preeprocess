...
#读取 textvqa obj  lmdb
# env0=lmdb.open("../test_data/detectron.lmdb",map_size=10995116277)
# txn0=env0.begin(write=True)
# # for key,i in txn0.cursor():
# #     print(key)
...
data=txn0.get("000191.npy".encode())   #keys的value 也需要decode()
...
# # txn0.commit()
# data=txn0.get("keys".encode())   #keys的value 也需要decode()
# # print(pickle.loads(data)["features"].dtype)
# env0.close()
...
# env0=lmdb.open("../test_data/tep/MY_EST_CH_train_ocr_feature.lmdb",map_size=1995116277)
# txn0=env0.begin(write=True)
...
# #用来修改  obj 键值为npy的形式
# env_db1= lmdb.Environment('../test_data/EST_train_obj_lmdb2.lmdb',map_size=5995116277)
# env_db = lmdb.Environment('../test_data/EST_train_obj_lmdb',map_size=3089934592)
# txn = env_db.begin(write=True)
...
#             fea["features"]=numpy.array([[1.0]*2048],dtype=numpy.float64)
#             numpy.asarray(fea["features"],dtype=numpy.float64)
